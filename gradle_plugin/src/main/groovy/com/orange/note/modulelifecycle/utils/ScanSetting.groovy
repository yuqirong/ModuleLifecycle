 ...
 */
class ScanSetting {
    static final String PLUGIN_NAME = "com.orange.note.modulelifecycle"
    /**
     * The register code is generated into this class
     */
    static final String GENERATE_TO_CLASS_NAME = 'com/orange/note/modulelifecycle/ModuleLifecycle'
    /**
     ...
     */
    static final String GENERATE_TO_METHOD_NAME = 'registerModule'
    /**
     * The package name of the class generated by the annotationProcessor
     */
    static final String ROUTER_CLASS_PACKAGE_NAME = 'com/orange/note/modulelifecycle/template/'
    /**
     * The package name of the interfaces
     */
    private static final INTERFACE_PACKAGE_NAME = 'com/orange/note/modulelifecycle/template/'
